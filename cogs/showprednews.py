...
class preview_news(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
    
    #неУпом рольки/с выбором цвета
    class send_withcolor(disnake.ui.Modal):
        def __init__(self, image, linknews, bot: commands.Bot, color: disnake.Color):
            self.image = image
            self.bot = bot
    ...
    #неУпом рольки
    class send_nocolor(disnake.ui.Modal):
        def __init__(self, image, linknews, bot: commands.Bot):
            self.image = image
            self.bot = bot
            self.linknews = linknews
    ...
    @commands.slash_command(name='preview_news')
    async def preview_news(self, 
